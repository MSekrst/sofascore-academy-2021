...
Applications will use SofaScore API, available on the route base: `https://master.dev.sofascore.com/api/v1`.

All other routes are generated by appending a suffix to the base written before.

| Path                                                                        | Response                         | Example route                                                                     |
| :-------------------------------------------------------------------------- | :------------------------------- | :-------------------------------------------------------------------------------- |
| [/sport/{sport}/{date}/{offset}/categories](###Category-List)               | `{ categories: CategoryInfo[] }` | https://master.dev.sofascore.com/api/v1/sport/football/2021-05-07/7200/categories |
| [/category/{categoryID}/scheduled-events/{date}](###Category-Events)        | `{ events: Event[] }`            | https://master.dev.sofascore.com/api/v1/category/1/scheduled-events/2021-05-07    |
| [/event/{eventID}](###Event-Details)                                        | `{ event: Event }`               | https://master.dev.sofascore.com/api/v1/event/8897123                             |
| [/team/{teamID}/image](###Team-Image)                                       | Team logo PNG image              | https://master.dev.sofascore.com/api/v1/team/31/image                             |
| [/unique-tournament/{uniqueTournamentID}/image](###Unique-Tournament-Image) | Unique Tournament logo PNG image | https://master.dev.sofascore.com/api/v1/unique-tournament/17/image                |
...
If you need help with deployment, I can assist you as I have some experience with Vercel and Heroku.
