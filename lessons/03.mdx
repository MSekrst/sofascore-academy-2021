...
- `await` keyword pauses the execution of the `async` function until the promise is resolved
...
- XHR -> defined by Microsoft in the 90s, the developer has to manually handle fetching state
